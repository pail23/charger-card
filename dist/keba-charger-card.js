 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,r=null)=>{for(;e!==r;){const r=e.nextSibling;t.removeChild(e),e=r}},r=`{{lit-${String(Math.random()).slice(2)}}}`,i=`\x3c!--${r}--\x3e`,o=new RegExp(`${r}|${i}`);class s{constructor(t,e){this.parts=[],this.element=e;const i=[],s=[],a=document.createTreeWalker(e.content,133,null,!1);let d=0,h=-1,u=0;const{strings:p,values:{length:g}}=t;for(;u<g;){const t=a.nextNode();if(null!==t){if(h++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:r}=e;let i=0;for(let t=0;t<r;t++)n(e[t].name,"$lit$")&&i++;for(;i-- >0;){const e=p[u],r=c.exec(e)[2],i=r.toLowerCase()+"$lit$",s=t.getAttribute(i);t.removeAttribute(i);const n=s.split(o);this.parts.push({type:"attribute",index:h,name:r,strings:n}),u+=n.length-1}}"TEMPLATE"===t.tagName&&(s.push(t),a.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(r)>=0){const r=t.parentNode,s=e.split(o),a=s.length-1;for(let e=0;e<a;e++){let i,o=s[e];if(""===o)i=l();else{const t=c.exec(o);null!==t&&n(t[2],"$lit$")&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(o)}r.insertBefore(i,t),this.parts.push({type:"node",index:++h})}""===s[a]?(r.insertBefore(l(),t),i.push(t)):t.data=s[a],u+=a}}else if(8===t.nodeType)if(t.data===r){const e=t.parentNode;null!==t.previousSibling&&h!==d||(h++,e.insertBefore(l(),t)),d=h,this.parts.push({type:"node",index:h}),null===t.nextSibling?t.data="":(i.push(t),h--),u++}else{let e=-1;for(;-1!==(e=t.data.indexOf(r,e+1));)this.parts.push({type:"node",index:-1}),u++}}else a.currentNode=s.pop()}for(const t of i)t.parentNode.removeChild(t)}}const n=(t,e)=>{const r=t.length-e.length;return r>=0&&t.slice(r)===e},a=t=>-1!==t.index,l=()=>document.createComment(""),c=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function d(t,e){const{element:{content:r},parts:i}=t,o=document.createTreeWalker(r,133,null,!1);let s=u(i),n=i[s],a=-1,l=0;const c=[];let d=null;for(;o.nextNode();){a++;const t=o.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==n&&n.index===a;)n.index=null!==d?-1:n.index-l,s=u(i,s),n=i[s]}c.forEach((t=>t.parentNode.removeChild(t)))}const h=t=>{let e=11===t.nodeType?0:1;const r=document.createTreeWalker(t,133,null,!1);for(;r.nextNode();)e++;return e},u=(t,e=-1)=>{for(let r=e+1;r<t.length;r++){const e=t[r];if(a(e))return r}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const p=new WeakMap,g=t=>"function"==typeof t&&p.has(t),m={},f={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class b{constructor(t,e,r){this.__parts=[],this.template=t,this.processor=e,this.options=r}update(t){let e=0;for(const r of this.__parts)void 0!==r&&r.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),r=[],i=this.template.parts,o=document.createTreeWalker(e,133,null,!1);let s,n=0,l=0,c=o.nextNode();for(;n<i.length;)if(s=i[n],a(s)){for(;l<s.index;)l++,"TEMPLATE"===c.nodeName&&(r.push(c),o.currentNode=c.content),null===(c=o.nextNode())&&(o.currentNode=r.pop(),c=o.nextNode());if("node"===s.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(c.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(c,s.name,s.strings,this.options));n++}else this.__parts.push(void 0),n++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),v=` ${r} `;class A{constructor(t,e,r,i){this.strings=t,this.values=e,this.type=r,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",o=!1;for(let s=0;s<t;s++){const t=this.strings[s],n=t.lastIndexOf("\x3c!--");o=(n>-1||o)&&-1===t.indexOf("--\x3e",n+1);const a=c.exec(t);e+=null===a?t+(o?v:i):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+r}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==y&&(e=y.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const w=t=>null===t||!("object"==typeof t||"function"==typeof t),x=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class S{constructor(t,e,r){this.dirty=!0,this.element=t,this.name=e,this.strings=r,this.parts=[];for(let t=0;t<r.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new V(this)}_getValue(){const t=this.strings,e=t.length-1,r=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=r[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!x(t))return t}let i="";for(let o=0;o<e;o++){i+=t[o];const e=r[o];if(void 0!==e){const t=e.value;if(w(t)||!x(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[e],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class V{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===m||w(t)&&t===this.value||(this.value=t,g(t)||(this.committer.dirty=!0))}commit(){for(;g(this.value);){const t=this.value;this.value=m,t(this)}this.value!==m&&this.committer.commit()}}class O{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(l()),this.endNode=t.appendChild(l())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=l()),t.__insert(this.endNode=l())}insertAfterPart(t){t.__insert(this.startNode=l()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;g(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=m,t(this)}const t=this.__pendingValue;t!==m&&(w(t)?t!==this.value&&this.__commitText(t):t instanceof A?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):x(t)?this.__commitIterable(t):t===f?(this.value=f,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,r="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=r:this.__commitNode(document.createTextNode(r)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof b&&this.value.template===e)this.value.update(t.values);else{const r=new b(e,t.processor,this.options),i=r._clone();r.update(t.values),this.__commitNode(i),this.value=r}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let r,i=0;for(const o of t)r=e[i],void 0===r&&(r=new O(this.options),e.push(r),0===i?r.appendIntoPart(this):r.insertAfterPart(e[i-1])),r.setValue(o),r.commit(),i++;i<e.length&&(e.length=i,this.clear(r&&r.endNode))}clear(t=this.startNode){e(this.startNode.parentNode,t.nextSibling,this.endNode)}}class C{constructor(t,e,r){if(this.value=void 0,this.__pendingValue=void 0,2!==r.length||""!==r[0]||""!==r[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=r}setValue(t){this.__pendingValue=t}commit(){for(;g(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=m,t(this)}if(this.__pendingValue===m)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=m}}class k extends S{constructor(t,e,r){super(t,e,r),this.single=2===r.length&&""===r[0]&&""===r[1]}_createPart(){return new M(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class M extends V{}let P=!1;(()=>{try{const t={get capture(){return P=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class z{constructor(t,e,r){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=r,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;g(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=m,t(this)}if(this.__pendingValue===m)return;const t=this.__pendingValue,e=this.value,r=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||r);r&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),i&&(this.__options=T(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=m}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const T=t=>t&&(P?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function X(t){let e=j.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},j.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const o=t.strings.join(r);return i=e.keyString.get(o),void 0===i&&(i=new s(t,t.getTemplateElement()),e.keyString.set(o,i)),e.stringsArray.set(t.strings,i),i}const j=new Map,q=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,r,i){const o=e[0];if("."===o){return new k(t,e.slice(1),r).parts}if("@"===o)return[new z(t,e.slice(1),i.eventContext)];if("?"===o)return[new C(t,e.slice(1),r)];return new S(t,e,r).parts}handleTextExpression(t){return new O(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const K=(t,...e)=>new A(t,e,"html",D)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */,I=(t,e)=>`${t}--${e}`;let H=!0;void 0===window.ShadyCSS?H=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),H=!1);const Z=t=>e=>{const i=I(e.type,t);let o=j.get(i);void 0===o&&(o={stringsArray:new WeakMap,keyString:new Map},j.set(i,o));let n=o.stringsArray.get(e.strings);if(void 0!==n)return n;const a=e.strings.join(r);if(n=o.keyString.get(a),void 0===n){const r=e.getTemplateElement();H&&window.ShadyCSS.prepareTemplateDom(r,t),n=new s(e,r),o.keyString.set(a,n)}return o.stringsArray.set(e.strings,n),n},U=["html","svg"],F=new Set,W=(t,e,r)=>{F.add(t);const i=r?r.element:document.createElement("template"),o=e.querySelectorAll("style"),{length:s}=o;if(0===s)return void window.ShadyCSS.prepareTemplateStyles(i,t);const n=document.createElement("style");for(let t=0;t<s;t++){const e=o[t];e.parentNode.removeChild(e),n.textContent+=e.textContent}(t=>{U.forEach((e=>{const r=j.get(I(e,t));void 0!==r&&r.keyString.forEach((t=>{const{element:{content:e}}=t,r=new Set;Array.from(e.querySelectorAll("style")).forEach((t=>{r.add(t)})),d(t,r)}))}))})(t);const a=i.content;r?function(t,e,r=null){const{element:{content:i},parts:o}=t;if(null==r)return void i.appendChild(e);const s=document.createTreeWalker(i,133,null,!1);let n=u(o),a=0,l=-1;for(;s.nextNode();)for(l++,s.currentNode===r&&(a=h(e),r.parentNode.insertBefore(e,r));-1!==n&&o[n].index===l;){if(a>0){for(;-1!==n;)o[n].index+=a,n=u(o,n);return}n=u(o,n)}}(r,n,a.firstChild):a.insertBefore(n,a.firstChild),window.ShadyCSS.prepareTemplateStyles(i,t);const l=a.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)e.insertBefore(l.cloneNode(!0),e.firstChild);else if(r){a.insertBefore(n,a.firstChild);const t=new Set;t.add(n),d(r,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const J={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},E=(t,e)=>e!==t&&(e==e||t==t),N={attribute:!0,type:String,converter:J,reflect:!1,hasChanged:E};class L extends HTMLElement{constructor(){super(),this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach(((e,r)=>{const i=this._attributeNameForProperty(r,e);void 0!==i&&(this._attributeToPropertyMap.set(i,r),t.push(i))})),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach(((t,e)=>this._classProperties.set(e,t)))}}static createProperty(t,e=N){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const r="symbol"==typeof t?Symbol():"__"+t,i=this.getPropertyDescriptor(t,r,e);void 0!==i&&Object.defineProperty(this.prototype,t,i)}static getPropertyDescriptor(t,e,r){return{get(){return this[e]},set(i){const o=this[t];this[e]=i,this.requestUpdateInternal(t,o,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||N}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty("finalized")||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const r of e)this.createProperty(r,t[r])}}static _attributeNameForProperty(t,e){const r=e.attribute;return!1===r?void 0:"string"==typeof r?r:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,r=E){return r(t,e)}static _propertyValueFromAttribute(t,e){const r=e.type,i=e.converter||J,o="function"==typeof i?i:i.fromAttribute;return o?o(t,r):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const r=e.type,i=e.converter;return(i&&i.toAttribute||J.toAttribute)(t,r)}initialize(){this._updateState=0,this._updatePromise=new Promise((t=>this._enableUpdatingResolver=t)),this._changedProperties=new Map,this._saveInstanceProperties(),this.requestUpdateInternal()}_saveInstanceProperties(){this.constructor._classProperties.forEach(((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}}))}_applyInstanceProperties(){this._instanceProperties.forEach(((t,e)=>this[e]=t)),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,r){e!==r&&this._attributeToProperty(t,r)}_propertyToAttribute(t,e,r=N){const i=this.constructor,o=i._attributeNameForProperty(t,r);if(void 0!==o){const t=i._propertyValueToAttribute(e,r);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(o):this.setAttribute(o,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const r=this.constructor,i=r._attributeToPropertyMap.get(t);if(void 0!==i){const t=r.getPropertyOptions(i);this._updateState=16|this._updateState,this[i]=r._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}requestUpdateInternal(t,e,r){let i=!0;if(void 0!==t){const o=this.constructor;r=r||o.getPropertyOptions(t),o._valueHasChanged(this[t],e,r.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==r.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,r))):i=!1}!this._hasRequestedUpdate&&i&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this.requestUpdateInternal(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){if(!this._hasRequestedUpdate)return;this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach(((t,e)=>this._propertyToAttribute(e,this[e],t))),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}L.finalized=!0;
/**
@license
...
*/
const R=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,B=Symbol();class Q{constructor(t,e){if(e!==B)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(R?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const Y=(t,...e)=>{const r=e.reduce(((e,r,i)=>e+(t=>{if(t instanceof Q)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(r)+t[i+1]),t[0]);return new Q(r,B)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const G={};class _ extends L{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,r)=>t.reduceRight(((t,r)=>Array.isArray(r)?e(r,t):(t.add(r),t)),r),r=e(t,new Set),i=[];r.forEach((t=>i.unshift(t))),this._styles=i}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!R){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new Q(String(e),B)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?R?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==G&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return G}}_.finalized=!0,_.render=(t,r,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const o=i.scopeName,s=q.has(r),n=H&&11===r.nodeType&&!!r.host,a=n&&!F.has(o),l=a?document.createDocumentFragment():r;if(((t,r,i)=>{let o=q.get(r);void 0===o&&(e(r,r.firstChild),q.set(r,o=new O(Object.assign({templateFactory:X},i))),o.appendInto(r)),o.setValue(t),o.commit()})(t,l,Object.assign({templateFactory:Z(o)},i)),a){const t=q.get(l);q.delete(l);const i=t.value instanceof b?t.value.template:void 0;W(o,l,i),e(r,r.firstChild),r.appendChild(l),q.set(r,t)}!s&&n&&window.ShadyCSS.styleElement(r.host)};var $=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,tt="[^\\s]+",et=/\[([^]*?)\]/gm;function rt(t,e){for(var r=[],i=0,o=t.length;i<o;i++)r.push(t[i].substr(0,e));return r}var it=function(t){return function(e,r){var i=r[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return i>-1?i:null}};function ot(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];for(var i=0,o=e;i<o.length;i++){var s=o[i];for(var n in s)t[n]=s[n]}return t}var st=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],nt=["January","February","March","April","May","June","July","August","September","October","November","December"],at=rt(nt,3),lt={dayNamesShort:rt(st,3),dayNames:st,monthNamesShort:at,monthNames:nt,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},ct=ot({},lt),dt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},ht={D:function(t){return String(t.getDate())},DD:function(t){return dt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return dt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return dt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return dt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return dt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return dt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return dt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return dt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return dt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return dt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return dt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+dt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+dt(Math.floor(Math.abs(e)/60),2)+":"+dt(Math.abs(e)%60,2)}},ut=function(t){return+t-1},pt=[null,"[1-9]\\d?"],gt=[null,tt],mt=["isPm",tt,function(t,e){var r=t.toLowerCase();return r===e.amPm[0]?0:r===e.amPm[1]?1:null}],ft=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var r=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?r:-r}return 0}],bt=(it("monthNamesShort"),it("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var yt=function(t,e,r){if(void 0===e&&(e=bt.default),void 0===r&&(r={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var i=[];e=(e=bt[e]||e).replace(et,(function(t,e){return i.push(e),"@@@"}));var o=ot(ot({},ct),r);return(e=e.replace($,(function(e){return ht[e](t,o)}))).replace(/@@@/g,(function(){return i.shift()}))},vt=(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}(),function(t,e,r,i){i=i||{},r=null==r?{}:r;var o=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return o.detail=r,t.dispatchEvent(o),o});var At={disconnected:"Disconnected",awaiting_start:"Paused or awaiting start",charging:"Charging",completed:"Completed or awaiting car",error:"Error",ready_to_charge:"Ready to charge"},wt={name:"Charger Card",description:"Charger card allows you to control your charging robot.",start:"Start",continue:"Resume",pause:"Pause",stop:"Stop",override:"Override schedule",reboot:"Reboot charger",not_available:"Charger not available",click_for_info:"Click for Info",click_for_config:"Click for Config",click_for_limits:"Click for Limits",online:"Online",voltage:"Voltage",power:"Power",charger_current:"Changer Current",energy_per_hour:"Energy per Hour",lifetime_energy:"Lifetime Energy",circuit_current:"Circuit Energy"},xt={missing_entity:"Specifying entity is required!"},St={entity:"Entity (Required)",chargerImage:"Charger image and color",customImage:"Custom image (Optional - overrides charger image)",theme:"Color theme",compact_view:"Compact View",compact_view_aria_label_on:"Toggle compact view on",compact_view_aria_label_off:"Toggle compact view off",show_name:"Show Name",show_name_aria_label_on:"Toggle display name on",show_name_aria_label_off:"Toggle display name off",show_leds:"Show Leds",show_leds_aria_label_on:"Toggle animated leds (overlay on image) on",show_leds_aria_label_off:"Toggle animated leds (overlay on image) off",show_status:"Show Status",show_status_aria_label_on:"Toggle display status on",show_status_aria_label_off:"Toggle display status off",show_stats:"Show Data Table (stats)",show_stats_aria_label_on:"Toggle display data table on",show_stats_aria_label_off:"Toggle display data table off",show_collapsibles:"Show collapsible menu buttons",show_collapsibles_aria_label_on:"Toggle display collapsible menus on",show_collapsibles_aria_label_off:"Toggle display collapsible menus off",show_toolbar:"Show Toolbar",show_toolbar_aria_label_on:"Toggle display toolbar on",show_toolbar_aria_label_off:"Toggle display toolbar off",code_only_note:"Note: Custom actions and data table (stats) options are available exclusively using Code Editor manually."},Vt={sessionEnergy:"Session Energy"},Ot={not_requesting_current:"Not requesting current",ok:"Ok",pending_schedule:"Pending Schedule",none:"None",max_circuit_current_too_low:"Max circuit current too low",max_dynamic_circuit_current_too_low:"Max dynamic circuit current too low",max_dynamic_offline_fallback_circuit_current_too_low:"Max dynamic offline circuit current too low",circuit_fuse_too_low:"Circuit fuse too low",waiting_in_queue:"Waiting in queue",waiting_in_fully:"Waiting in fully",illegal_grid_type:"Illegal grid type",no_current_request:"No current request",max_charger_current_too_low:"Max charger current too low",max_dynamic_charger_current_too_low:"Max dynamic charger current too low",charger_disabled:"Charger Disabled",pending_authorization:"Pending Authorization",charger_in_error_state:"Charger in error state",undefined:"Undefined"},Ct={status:At,common:wt,error:xt,editor:St,charger_status:Vt,charger_substatus:Ot},kt={disconnected:"Frakoblet",awaiting_start:"Pauset eller venter start",charging:"Lader",completed:"Fullført eller venter på bil",error:"Feil",ready_to_charge:"Klar til lading"},Mt={name:"Charger Card",description:"Charger card gir deg mulighet for å styre din laderobot.",start:"Start",continue:"Fortsett",pause:"Pause",stop:"Stopp",override:"Overstyr plan",reboot:"Reboot lader",not_available:"Lader utilgjengelig",click_for_info:"Klikk for info",click_for_config:"Klikk for konfigurasjon",click_for_limits:"Klikk for limiteringer",online:"Online",voltage:"Spenning",power:"Effekt",charger_current:"Ladestrøm",energy_per_hour:"Energi per time",lifetime_energy:"Energi totalt",circuit_current:"Kursstrøm"},Pt={missing_entity:"Du må angi en entity!"},zt={entity:"Entity (Påkrevd)",chargerImage:"Laderbilde og -farge",customImage:"Eget bilde (opsjon - overstyrer laderbilde)",theme:"Fargemal",compact_view:"Kompakt",compact_view_aria_label_on:"Toggle compact view on",compact_view_aria_label_off:"Toggle compact view off",show_name:"Vis navn",show_name_aria_label_on:"Toggle display name on",show_name_aria_label_off:"Toggle display name off",show_leds:"Vis led",show_leds_aria_label_on:"Toggle animated leds (overlay on image) on",show_leds_aria_label_off:"Toggle animated leds (overlay on image) off",show_status:"Vis status",show_status_aria_label_on:"Toggle display status on",show_status_aria_label_off:"Toggle display status off",show_stats:"Vis Data Tabell (stats)",show_stats_aria_label_on:"Toggle display data table on",show_stats_aria_label_off:"Toggle display data table off",show_collapsibles:"Vis sammenslåbare menyvalg",show_collapsibles_aria_label_on:"Toggle display collapsible menus on",show_collapsibles_aria_label_off:"Toggle display collapsible menus off",show_toolbar:"Vis verktøylinje",show_toolbar_aria_label_on:"Toggle display toolbar on",show_toolbar_aria_label_off:"Toggle display toolbar off",code_only_note:"Merk: Egendefinerte actions og data tabell (stats) er kun tilgjengelig ved å benytte Code Editor manuelt."},Tt={sessionEnergy:"Energi ladeøkt"},Xt={not_requesting_current:"Bilen ber ikke om strøm",ok:"Ok"},jt={status:kt,common:Mt,error:Pt,editor:zt,charger_status:Tt,charger_substatus:Xt},qt={disconnected:"Frånkopplad",awaiting_start:"Pausad eller inväntar start",charging:"Laddar",completed:"Färdig eller inväntar bil",error:"Error",ready_to_charge:"Klar att ladda"},Dt={name:"Charger Card",description:"Charger card ger dig möjlighet att styra din laddningsrobot.",start:"Starta",continue:"Återuppta",pause:"Pausa",stop:"Stopp",override:"Åsidosätt schema",reboot:"Starta om laddared",not_available:"Laddaren inte tillgänglig",click_for_info:"Klicka för info",click_for_config:"Klicka för konfigurering",click_for_limits:"Klicka för begränsningar",online:"Uppkopplad",voltage:"Spänning",power:"Kraft",charger_current:"Laddningsenergi",energy_per_hour:"Energi per timme",lifetime_energy:"Livstids energi",circuit_current:"Kretsenergi"},Kt={missing_entity:"Entiteten måsta anges!"},It={entity:"Entitet (Obligatorisk)",chargerImage:"Laddar bild och färg",customImage:"Egen bild (Frivilligt - åsidosätter laddarbild)",theme:"Färgtema",compact_view:"Kompakt vy",compact_view_aria_label_on:"Toggle compact view on",compact_view_aria_label_off:"Toggle compact view off",show_name:"Visa namn",show_name_aria_label_on:"Toggle display name on",show_name_aria_label_off:"Toggle display name off",show_leds:"Visa Leds",show_leds_aria_label_on:"Toggle animated leds (overlay on image) on",show_leds_aria_label_off:"Toggle animated leds (overlay on image) off",show_status:"Visa Status",show_status_aria_label_on:"Toggle display status on",show_status_aria_label_off:"Toggle display status off",show_stats:"Visa Data Tabell (stats)",show_stats_aria_label_on:"Toggle display data table on",show_stats_aria_label_off:"Toggle display data table off",show_collapsibles:"Show collapsible menu buttons",show_collapsibles_aria_label_on:"Toggle display collapsible menus on",show_collapsibles_aria_label_off:"Toggle display collapsible menus off",show_toolbar:"Visa verktygsfält",show_toolbar_aria_label_on:"Toggle display toolbar on",show_toolbar_aria_label_off:"Toggle display toolbar off",code_only_note:"Notera: Egendefinierade Custom actions och data tabell (stats) är bara tillgängligt när Code Editorn används manuellt."},Ht={sessionEnergy:"Sessionsenergi"},Zt={not_requesting_current:"Ingen bil ansluten",ok:"Klar"},Ut={status:qt,common:Dt,error:Kt,editor:It,charger_status:Ht,charger_substatus:Zt},Ft={disconnected:"Getrennt",awaiting_start:"Pausiert oder warte auf Start",charging:"Laden",completed:"Fertig oder warte auf Auto",error:"Fehler",ready_to_charge:"Bereit zum Laden"},Wt={name:"Charger Card",description:"Charger card ermöglicht es dir, deinen Laderoboter zu steuern.",start:"Start",continue:"Weiter",pause:"Pause",stop:"Stopp",override:"Zeitplan überschreiben",reboot:"Ladegerät neu starten",not_available:"Ladegerät nicht verfügbar",click_for_info:"Klicken für Infos",click_for_config:"Klicken für Konfiguration",click_for_limits:"Klicken für Limits",online:"Online",voltage:"Spannung",power:"Leistung",charger_current:"Ladestrom",energy_per_hour:"Energie pro Stunde",lifetime_energy:"Energie gesamt",circuit_current:"Aktueller Strom"},Jt={missing_entity:"Die Angabe der Entität ist erforderlich!"},Et={entity:"Entity (Erforderlich)",chargerImage:"Bild und Farbe des Ladegeräts",customImage:"Benutzerdefiniertes Bild (Optional - überschreibt das Bild des Ladegeräts)",theme:"Farbschema",compact_view:"Kompakte Ansicht",compact_view_aria_label_on:"Kompakte Ansicht einschalten",compact_view_aria_label_off:"Kompakte Ansicht ausschalten",show_name:"Name anzeigen",show_name_aria_label_on:"Anzeigename einschalten",show_name_aria_label_off:"Anzeigename ausschalten",show_leds:"Leds anzeigen",show_leds_aria_label_on:"Animierte Leds (Überlagerung des Bildes) einschalten",show_leds_aria_label_off:"Animierte Leds (Überlagerung des Bildes) ausschalten",show_status:"Status anzeigen",show_status_aria_label_on:"Statusanzeige einschalten",show_status_aria_label_off:"Statusanzeige ausschalten",show_stats:"Datentabelle anzeigen (Statistik)",show_stats_aria_label_on:"Datentabelle einschalten",show_stats_aria_label_off:"Datentabelle ausschalten",show_collapsibles:"Zusammenklappbare Menüschaltflächen anzeigen",show_collapsibles_aria_label_on:"Zusammenklappbare Menüschaltflächen einschalten",show_collapsibles_aria_label_off:"Zusammenklappbare Menüschaltflächen ausschalten",show_toolbar:"Symbolleiste anzeigen",show_toolbar_aria_label_on:"Symbolleiste einschalten",show_toolbar_aria_label_off:"Symbolleiste ausschalten",code_only_note:"Hinweis: Die Optionen für benutzerdefinierte Aktionen und Datentabellen (Statistiken) sind ausschließlich über den manuellen Code-Editor verfügbar."},Nt={sessionEnergy:"Energieaufladung"},Lt={not_requesting_current:"Keine Nachfrage nach Strom",ok:"Ok",pending_schedule:"Ausstehender Zeitplan",none:"None",max_circuit_current_too_low:"Maximalstrom zu niedrig",max_dynamic_circuit_current_too_low:"Dynamischer Maximalstrom zu niedrig",max_dynamic_offline_fallback_circuit_current_too_low:"Dynamischer offline Maximalstrom zu niedrig",circuit_fuse_too_low:"Stromkreissicherung zu niedrig",waiting_in_queue:"Warten in der Warteschlange",waiting_in_fully:"Warten in vollem Umfang",illegal_grid_type:"Unzulässiger Grid Typ",no_current_request:"Keine aktuelle Anfrage",max_charger_current_too_low:"Maximaler Ladestrom zu niedrig",max_dynamic_charger_current_too_low:"Maximaler dynamischer Ladestrom zu niedrig",charger_disabled:"Ladegerät Deaktiviert",pending_authorization:"Ausstehende Autorisierung",charger_in_error_state:"Ladegerät im Fehlerzustand",undefined:"Undefiniert"},Rt={status:Ft,common:Wt,error:Jt,editor:Et,charger_status:Nt,charger_substatus:Lt},Bt={en:Object.freeze({__proto__:null,status:At,common:wt,error:xt,editor:St,charger_status:Vt,charger_substatus:Ot,default:Ct}),nb:Object.freeze({__proto__:null,status:kt,common:Mt,error:Pt,editor:zt,charger_status:Tt,charger_substatus:Xt,default:jt}),sv:Object.freeze({__proto__:null,status:qt,common:Dt,error:Kt,editor:It,charger_status:Ht,charger_substatus:Zt,default:Ut}),de:Object.freeze({__proto__:null,status:Ft,common:Wt,error:Jt,editor:Et,charger_status:Nt,charger_substatus:Lt,default:Rt})};function Qt(t,e,r){const[i,o]=t.split(".");let s;try{s=JSON.parse(localStorage.getItem("selectedLanguage"))}catch(t){s=localStorage.getItem("selectedLanguage")}const n=(s||navigator.language.split("-")[0]||"en").replace(/['"]+/g,"").replace("-","_");let a;try{a=Bt[n][i][o]}catch(t){a=Bt.en[i][o]}if(void 0===a&&(a=Bt.en[i][o]),void 0!==a)return""!==e&&""!==r&&(a=a.replace(e,r)),a}const Yt="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIGAgIAAAAAAAAAAAAACDYSPqcvtD6OctNqLVQEAOw==",Gt="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHD///8AAAAAAAACGYSDqZvmwOJ6R1oKrcR60x5x4PSNimgiTgEAOw==",_t="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHAAJv8AAAAAAAACGYSDqZvmwOJ6R1oKrcR60x5x4PSNimgiTgEAOw==",$t="data:image/gif;base64,R0lGODlhAwBIAIEAAAAAAGBgYP8AAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh/hZDcmVhdGVkIHdpdGggUGFpbnQuTkVUACH5BAkZAAAALAAAAAADAEgAAAINjI+py+0Po5y02otVAQAh+QQJGQAAACwAAAEAAwBGAAACF5SPecCtn5qDVDJaLYYW7Nd9SigiZGkUADs=",te="disconnected",ee="awaiting_start",re="charging",ie="completed",oe="error",se="ready_to_charge",ne={normal:{DEFAULT:Yt,disconnected:"data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHBgYGD///8AAAACHYSDqZvmwOJ6R1oKrcR60x5x4EQJ5ommJ6a2qVMAADs=",awaiting_start:Gt,charging:"data:image/gif;base64,",completed:Gt,error:$t,ready_to_charge:Gt},smart:{DEFAULT:Yt,disconnected:"data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHBgYGAAJv8AAAACHYSDqZvmwOJ6R1oKrcR60x5x4EQJ5ommJ6a2qVMAADs=",awaiting_start:_t,charging:"data:image/gif;base64,",completed:_t,error:$t,ready_to_charge:_t}},ae="binary_sensor.plug",le="switch.cable_locked_permanently",ce="binary_sensor.charging_state",de="binary_sensor.basic_schedule",he="sensor.circuit_current",ue="sensor.cost_per_kwh",pe="sensor.dynamic_charger_limit",ge="sensor.dynamic_circuit_limit",me="switch.enable_idle_current",fe="sensor.current",be="switch.is_enabled",ye="sensor.max_current",ve="sensor.max_circuit_limit",Ae="sensor.offline_circuit_limit",we="binary_sensor.status",xe="sensor.output_limit",Se="sensor.reason_for_no_current",Ve="sensor.session_energy",Oe="sensor.energy_per_hour",Ce="sensor.total_energy",ke="switch.smart_charging",Me="sensor.charging_power",Pe="binary_sensor.update_available",ze="sensor.voltage",Te="set_charger_max_limit",Xe="set_charger_dynamic_limit",je="set_charger_circuit_max_limit",qe="set_charger_circuit_dynamic_limit",De="set_charger_circuit_offline_limit",Ke=[{name:"Generic",img:"data:image/png;base64,"}],Ie={"binary_sensor.plug":"mdi:lock","switch.cable_locked_permanently":"mdi:lock","binary_sensor.basic_schedule":"mdi:clock-check","sensor.circuit_current":"mdi:sine-wave","sensor.cost_per_kwh":"mdi:currency-usd","sensor.dynamic_charger_limit":"mdi:sine-wave","sensor.dynamic_circuit_limit":"mdi:sine-wave","switch.enable_idle_current":"mdi:current-dc","sensor.offline_circuit_limit":"mdi:sine-wave","sensor.current":"mdi:sine-wave","switch.is_enabled":"mdi:power","sensor.max_current":"mdi:sine-wave","sensor.max_circuit_limit":"mdi:sine-wave","binary_sensor.status":"mdi:wifi","sensor.output_limit":"mdi:sine-wave","sensor.reason_for_no_current":"mdi:alert-circle","sensor.session_energy":"mdi:flash","sensor.energy_per_hour":"mdi:flash","sensor.total_energy":"mdi:flash","switch.smart_charging":"mdi:auto-fix","sensor.charging_power":"mdi:flash","binary_sensor.update_available":"mdi:file-download","sensor.voltage":"mdi:sine-wave"},He=[8,10,16,20,25,32],Ze=[{name:"theme_default",desc:"Default HA colors"},{name:"theme_custom",desc:"Use custom theme"},{name:"theme_transp_blue",desc:"Transparent Blue"},{name:"theme_transp_black",desc:"Transparent Black"},{name:"theme_transp_white",desc:"Transparent White"},{name:"theme_lightgrey_blue",desc:"LightGrey Blue"}];customElements.define("keba-charger-card-editor",class extends _{static get properties(){return{hass:Object,_config:Object,_toggle:Boolean}}setConfig(t){this._config=t,this._config.entity||(this._config.entity=this.getEntitiesByType("binary_sensor")[0]||"",vt(this,"config-changed",{config:this._config}))}get _entity(){return this._config&&this._config.entity||""}get _customImage(){return this._config&&this._config.customImage||""}get _chargerImage(){return this._config&&this._config.chargerImage||"Generic"}get _customCardTheme(){return this._config?this._config.customCardTheme||"":"theme_default"}get _show_name(){return!this._config||(void 0===this._config.show_name||this._config.show_name)}get _show_leds(){return!this._config||(void 0===this._config.show_leds||this._config.show_leds)}get _show_status(){return!this._config||(void 0===this._config.show_status||this._config.show_status)}get _show_toolbar(){return!this._config||(void 0===this._config.show_toolbar||this._config.show_toolbar)}get _show_stats(){return!this._config||(void 0===this._config.show_stats||this._config.show_stats)}get _show_collapsibles(){return!this._config||(void 0===this._config.show_collapsibles||this._config.show_collapsibles)}get _compact_view(){return!!this._config&&(void 0!==this._config.compact_view&&this._config.compact_view)}getEntitiesByType(t){return Object.keys(this.hass.states).filter((e=>e.substr(0,e.indexOf("."))===t))}render(){if(!this.hass)return K``;const t=this.getEntitiesByType("binary_sensor");return K`
      <div class="card-config">
        ...
        <paper-dropdown-menu label="${Qt("editor.chargerImage")}" @value-changed=${this._valueChanged} .configValue=${"chargerImage"}>
        ...
        <paper-input label="${Qt("editor.customImage")}" .value=${this._customImage} .configValue=${"customImage"} @value-changed=${this._valueChanged}"></paper-input>

        <p class="option">
          <ha-switch
            aria-label=${Qt(this._compact_view?"editor.compact_view_aria_label_off":"editor.compact_view_aria_label_on")}
            .checked=${!1!==this._compact_view}
            .configValue=${"compact_view"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Qt("editor.compact_view")}
        </p>
        ...
        <p class="option">
          ...
          ${Qt("editor.show_name")} [${this._show_name}]
        </p>

        <p class="option">
          <ha-switch
            aria-label=${Qt(this._show_leds?"editor.show_leds_aria_label_off":"editor.show_leds_aria_label_on")}
        ...
        <p class="option">
          <ha-switch
            aria-label=${Qt(this._show_status?"editor.show_status_aria_label_off":"editor.show_status_aria_label_on")}
            .checked=${!1!==this._show_status}
            .configValue=${"show_status"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Qt("editor.show_status")}
        </p>

        <p class="option">
        <ha-switch
          aria-label=${Qt(this._show_collapsibles?"editor.show_collapsibles_aria_label_off":"editor.show_collapsibles_aria_label_on")}
          .checked=${!1!==this._show_collapsibles}
          .configValue=${"show_collapsibles"}
          @change=${this._valueChanged}
        >
        </ha-switch>
        ${Qt("editor.show_collapsibles")}
      </p>

        <p class="option">
          <ha-switch
            aria-label=${Qt(this._show_stats?"editor.show_stats_aria_label_off":"editor.show_stats_aria_label_on")}
            .checked=${this._show_stats}
            .configValue=${"show_stats"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Qt("editor.show_stats")}
        </p>
        ...
        <p class="option">
          <ha-switch
            aria-label=${Qt(this._show_toolbar?"editor.show_toolbar_aria_label_off":"editor.show_toolbar_aria_label_on")}
    ...
    `}_valueChanged(t){if(!this._config||!this.hass)return void console.log("C: no config");const e=t.target;this["_"+e.configValue]!==e.value&&(e.configValue&&(""===e.value?delete this._config[e.configValue]:this._config={...this._config,[e.configValue]:void 0!==e.checked?e.checked:e.value}),vt(this,"config-changed",{config:this._config}))}static get styles(){return Y`
...
`;customElements.get("ha-icon-button")||customElements.define("ha-icon-button",class extends(customElements.get("paper-icon-button")){});customElements.define("keba-charger-card",class extends _{static get properties(){return{hass:Object,config:Object,requestInProgress:Boolean}}static get styles(){return Ue}static async getConfigElement(){return document.createElement("charger-card-editor")}static getStubConfig(t,e){const[r]=e.filter((t=>"sensor"===t.substr(0,t.indexOf("."))));return{entity:r||"",image:"default"}}get entity(){return this.hass.states[this.config.entity]}get chargerId(){return this.hass.states[this.config.entity].attributes.id}get chargerDomain(){return"keba"}get status(){if("off"==this.getEntityState(this.getEntity(ae)))return te;return"on"==this.getEntityState(this.getEntity(ce))?re:ee}get usedChargerLimit(){const{dynamicChargerCurrent:t,dynamicCircuitCurrent:e,maxChargerCurrent:r,maxCircuitCurrent:i}=this.getEntities(),o=this.hass.states[this.config.entity].attributes.circuit_ratedCurrent;return Math.min(this.getEntityState(t),this.getEntityState(e),this.getEntityState(r),this.getEntityState(i),o)}get image(){let t=this.config.chargerImage||"Generic";const e=Ke.find((({name:e})=>{if(e===t)return e}));if(void 0===this.config.customImage||""===this.config.customImage)try{return e.img}catch(t){return null}return this.config.customImage}get customCardTheme(){return void 0===this.config.customCardTheme?"theme_default":this.config.customCardTheme}get showLeds(){return void 0===this.config.show_leds||this.config.show_leds}get showName(){return void 0===this.config.show_name||this.config.show_name}get showStatus(){return void 0===this.config.show_status||this.config.show_status}get showStats(){return void 0===this.config.show_stats||this.config.show_stats}get showCollapsibles(){return void 0===this.config.show_collapsibles||this.config.show_collapsibles}get showToolbar(){return void 0===this.config.show_toolbar||this.config.show_toolbar}get compactView(){return void 0!==this.config.compact_view&&this.config.compact_view}get useStatsDefault(){return void 0===this.config.stats}get entityBasename(){return this.config.entity.split(".")[1].replace("_status","")}getEntityId(t){try{return t.split(".")[0]+"."+this.entityBasename+"_"+t.split(".")[1]}catch(t){return null}}getEntityBase(t){try{return t.split(".")[0]+"."+t.split(".")[1].replace(this.entityBasename+"_","")}catch(t){return null}}getEntities(){return{cableLocked:this.getEntity(ae),cableLockedPermanently:this.getEntity(le),chargingState:this.getEntity(ce),basicSchedule:this.getEntity(de),circuitCurrent:this.getEntity(he),costPerKwh:this.getEntity(ue),dynamicChargerCurrent:this.getEntity(pe),dynamicCircuitCurrent:this.getEntity(ge),enableIdleCurrent:this.getEntity(me),offlineCircuitCurrent:this.getEntity(Ae),inCurrent:this.getEntity(fe),isEnabled:this.getEntity(be),maxChargerCurrent:this.getEntity(ye),maxCircuitCurrent:this.getEntity(ve),isOnline:this.getEntity(we),outputCurrent:this.getEntity(xe),reasonForNoCurrent:this.getEntity(Se),sessionEnergy:this.getEntity(Ve),energyPerHour:this.getEntity(Oe),energyLifetime:this.getEntity(Ce),smartCharging:this.getEntity(ke),totalPower:this.getEntity(Me),updateAvailable:this.getEntity(Pe),voltage:this.getEntity(ze),status:this.entity}}getEntity(t){try{return this.hass.states[this.getEntityId(t)]}catch(t){return null}}getEntityState(t){try{return t.state}catch(t){return null}}getEntityAttribute(t,e){try{return t.attributes[e]}catch(t){return null}}getStatsDefault(t){switch(console.log("getStatsDefault "+t),t){case te:return[{entity_id:this.getEntityId(Ve),unit:"kWh",subtitle:Qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entity_id:this.getEntityId(ae),unit:"",subtitle:"Locked"}];case ee:return[{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entity_id:this.getEntityId(Ve),unit:"kWh",subtitle:Qt("charger_status.sessionEnergy")},{entity_id:this.getEntityId(ke),unit:"",subtitle:"Smart Charging"}];case re:return[{entity_id:this.getEntityId(Ve),unit:"kWh",subtitle:"Energy"},{entity_id:this.getEntityId(Oe),unit:"kWh/h",subtitle:"Rate"},{entity_id:this.getEntityId(he),unit:"A",subtitle:"Circuit"},{entity_id:this.getEntityId(xe),unit:"A",subtitle:"Allowed"},{entity_id:this.getEntityId(fe),unit:"A",subtitle:"Actual"},{entity_id:this.getEntityId(Me),unit:"kW",subtitle:"Power"}];case ie:case oe:return[{entity_id:this.getEntityId(Ve),unit:"kWh",subtitle:Qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"}];case se:return[{entity_id:this.getEntityId(Ve),unit:"kWh",subtitle:Qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entity_id:this.getEntityId(de),unit:"",subtitle:"Schedule"}]}}setConfig(t){if(!t.entity)throw new Error(Qt("error.missing_entity"));this.config=t}getCardSize(){return 2}shouldUpdate(t){return function(t,e,r){if(e.has("config")||r)return!0;if(t.config.entity){var i=e.get("hass");return!i||i.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!0)}updated(t){t.get("hass")&&t.get("hass").states[this.config.entity].state!==this.hass.states[this.config.entity].state&&(this.requestInProgress=!1)}handleMore(t=this.entity){vt(this,"hass-more-info",{entityId:t.entity_id},{bubbles:!0,composed:!0})}setServiceData(t,e,r){switch(t){case Te:{const i=r.target.getAttribute("value");return this.callService(t,e,{current:i})}case Xe:{const i=r.target.getAttribute("value");return this.callService(t,e,{current:i})}case De:{const i=r.target.getAttribute("value");return this.callService(t,e,{currentP1:i})}case je:{const i=r.target.getAttribute("value");return this.callService(t,e,{currentP1:i})}case qe:{const i=r.target.getAttribute("value");return this.callService(t,e,{currentP1:i})}}}callService(t,e=!0,r={}){this.hass.callService(this.chargerDomain,t,{charger_id:this.chargerId,...r}),e&&this.requestUpdate()}getAttributes(t){const{status:e,state:r,friendly_name:i,name:o,site_name:s,icon:n}=t.attributes;return{status:e||r,friendly_name:i,name:o,site_name:s,icon:n}}imageLed(t,e){let r="normal";return"on"==e&&(r="smart"),ne[r][t]||ne[r].DEFAULT}renderImage(t){let e="";return this.compactView&&(e="-compact"),this.image?K` <img
        class="charger${e}"
        src="${this.image}"
        @click="${()=>this.handleMore()}"
        ?more-info="true"
      />${this.renderLeds(t)}`:K``}renderLeds(t){if(this.showLeds){let e="";this.compactView&&(e="-compact");const r=this.getEntityState(this.getEntity(ke));return K`<img
        class="charger led${e}"
        src="${this.imageLed(t,r)}"
        @click="${()=>this.handleMore()}"
        ?more-info="true"
      /> `}return K``}renderStats(t){if(!this.showStats)return K``;let e="";if(this.compactView&&(e="-compact"),this.useStatsDefault){const r=this.getStatsDefault(t)||[];return K`<div class="stats${e}">
        ${this.renderStatsList(t,r)}
      </div>`}{const{stats:r={}}=this.config,i=r[t]||r.default||[];return K`<div class="stats${e}">
        ${this.renderStatsList(t,i)}
      </div>`}}renderStatsList(t,e){return e.map((({entity_id:t,attribute:e,calcValue:r,unit:i,subtitle:o})=>{if(!(t||e||r))return K``;if(r)return this.renderStatsHtml(r,i,o);this.getEntity();try{const r=e?this.hass.states[t].attributes[e]:this.hass.states[t].state;return this.renderStatsHtml(r,i,o,this.hass.states[t])}catch(t){return null}}))}renderStatsHtml(t,e,r,i=this.entity){return K`
      <div
        class="stats-block"
        @click="${()=>this.handleMore(i)}"
        ?more-info="true"
      >
    ...
    `}renderName(){if(!this.showName)return K``;let t="";return this.compactView&&(t="-compact"),K`
      <div
        class="charger-name${t}"
        @click="${()=>this.handleMore()}"
        ?more-info="true"
      >
        Keba P30
      </div>
    `}renderStatus(){if(!this.showStatus)return K``;let t="";this.compactView&&(t="-compact");const e=Qt("status."+this.status)||this.status;return K`
      <div
        class="status${t}"
        @click="${()=>this.handleMore()}"
        ?more-info="true"
    ...
    `}renderCollapsibleConfig(){if(!this.showCollapsibles)return K``;const{cableLocked:t,cableLockedPermanently:e,enableIdleCurrent:r,isEnabled:i,smartCharging:o}=this.getEntities();let s=Qt("common.click_for_config");return K`
      <div class="wrap-collabsible">
        ...
        <div class="collapsible-content">
          <div class="content-inner">
            ${this.renderCollapsibleItems(i,"Enabled")}
            ${this.renderCollapsibleItems(r,"Idle Current")}
            ${this.renderCollapsibleItems(e,"Permanently Locked")}
            ${this.renderCollapsibleItems(t,"Locked")}
            ${this.renderCollapsibleItems(o,"Smart Charging")}
          </div>
        </div>
      </div>
    `}renderCollapsibleInfo(){if(!this.showCollapsibles)return K``;const{isOnline:t,voltage:e,totalPower:r,circuitCurrent:i,inCurrent:o,sessionEnergy:s,energyPerHour:n,energyLifetime:a}=this.getEntities();let l=Qt("common.click_for_info");return K`
      <div class="wrap-collabsible-info">
        ...
        <label for="collapsible-info" class="lbl-toggle-info">
          <div class="tooltip-right">
            ...
            <span class="tooltiptext-right">${l}</span>
          </div>
        </label>
        <div class="collapsible-content-info">
          <div class="content-inner-info">
            ${this.renderCollapsibleItems(t,Qt("common.online"))}
            ${this.renderCollapsibleItems(e,Qt("common.voltage"),!0)}
            ${this.renderCollapsibleItems(r,Qt("common.power"))}
            ${this.renderCollapsibleItems(o,Qt("common.charger_current"),!0)}
            ${this.renderCollapsibleItems(i,Qt("common.circuit_current"),!0)}
            ${this.renderCollapsibleItems(n,Qt("common.energy_per_hour"))}
            ${this.renderCollapsibleItems(s,Qt("charger_status.sessionEnergy"))}
            ${this.renderCollapsibleItems(a,Qt("common.lifetime_energy"),!0)}
          </div>
        </div>
      </div>
    `}renderCollapsibleLimits(){if(!this.showCollapsibles)return K``;const{maxChargerCurrent:t,maxCircuitCurrent:e,dynamicChargerCurrent:r,dynamicCircuitCurrent:i,offlineCircuitCurrent:o}=this.getEntities();let s=Qt("common.click_for_limits");return K`
      <div class="wrap-collabsible-lim">
        ...
        <div class="collapsible-content-lim">
          <div class="content-inner-lim">
            ${this.renderCollapsibleDropDownItems(t,Te,"Max Charger",void 0,"Max Charger Limit",!0)}
            ${this.renderCollapsibleDropDownItems(r,Xe,"Dyn Charger",void 0,"Dyn Charger Limit",!0)}
            ${this.renderCollapsibleDropDownItems(e,je,"Max Circuit",void 0,"Max Circuit Limit",!0)}
            ${this.renderCollapsibleDropDownItems(i,qe,"Dyn Circuit",void 0,"Dyn Circuit Limit",!0)}
            ${this.renderCollapsibleDropDownItems(o,De,"Off Lim",void 0,"Offline Limit",!0)}
          </div>
        </div>
      </div>
    `}renderCollapsibleItems(t,e,r=!1){if(null==t)return K`x`;let i=this.getEntityState(t),o=this.renderIcon(t),s=this.getEntityAttribute(t,"unit_of_measurement");return r&&(i=Math.round(i)),K`
      <div
    ...
    `}renderCollapsibleServiceItems(t,e,r,i,o,s=!0,n={}){let a=i;return null==i&&(a=this.renderIcon(t)),K`
      <div
        class="collapsible-item"
        @click="${()=>this.callService(e,s,n)}"
      >
        <div class="tooltip">
    ...
    `}renderCollapsibleDropDownItems(t,e,r,i,o,s=!0){if(null==t)return K``;const n=He;let a=this.getEntityState(t),l=n.indexOf(a),c=this.getEntityAttribute(t,"unit_of_measurement"),d=void 0===i?this.renderIcon(t):i;return K`
      <paper-menu-button
      ...
      >
        ...
        <paper-listbox
          ...
          selected=${l}
          @click="${t=>this.setServiceData(e,s,t)}"
        >
          ${n.map((t=>K`<paper-item value=${t}>${t}</paper-item>`))}
        </paper-listbox>
      </paper-menu-button>
    `}renderInfoItemsLeft(){const{isOnline:t}=this.getEntities();return K` ${this.renderInfoItem(t,Qt("common.online"))} `}renderInfoItemsRight(){const{totalPower:t,voltage:e}=this.getEntities();return K`
      ${this.renderInfoItem(e,Qt("common.voltage"),!0)}
      ${this.renderInfoItem(t,Qt("common.power"))}
    `}renderInfoItemsCompact(){const{totalPower:t,voltage:e}=this.getEntities();return K`
      ${this.renderInfoItem(e,Qt("common.voltage"),!0)}
      ${this.renderInfoItem(t,Qt("common.power"),!0)}
    `}renderInfoItem(t,e,r=!1){if(null==t)return K``;let i=this.getEntityState(t),o=this.getEntityAttribute(t,"unit_of_measurement"),s=this.renderIcon(t);return r&&(i=Math.round(i)),K`
      <div
    ...
    `}renderIcon(t){let e=t.entity_id,r=1==this.getEntityAttribute(t,"icon")?this.getEntityAttribute(t,"icon"):Ie[this.getEntityBase(e)]||"mdi:cancel",i=1==this.getEntityAttribute(t,"device_class")&&i(this.getEntityAttribute(t,"device_class"),this.getEntityState(t));return i||r}renderToolbar(t){if(!this.showToolbar)return K``;const{actions:e=[]}=this.config,r=e.map((({name:t,service:e,icon:r,service_data:i})=>this.renderToolbarButton(e,r,t,i)));let i=K``;switch(t){case te:i=K``;break;case ee:i=K`
          ${this.renderToolbarButton("disable","hass:stop","common.stop")}
          ${this.renderToolbarButton("enable","hass:play-pause","common.continue")}
        `;break;case re:case ie:i=K`
          ${this.renderToolbarButton("disable","hass:stop","common.stop")}
        `;break;case oe:i=K``;break;case se:i=K`
          ${this.renderToolbarButton("disable","hass:stop","common.stop")}
        `}return K`
      <div class="toolbar">
        ${i}
    ...
    `}renderToolbarButton(t,e,r,i={},o=!0){let s="";try{s=Qt(r)}catch(t){s=r}return K`
      <div class="tooltip">
        <ha-icon-button
          icon="${e}"
          title="${s}"
    ...
    `}renderCompact(){const t=this.status;return K`
      <ha-card>
    ...
    `}renderFull(){const t=this.status;return K`
      <ha-card>
        <div class="preview">
          <div class="header">
          ...
          ${this.renderCollapsibleLimits()} ${this.renderStats(t)}
        </div>

        ${this.renderToolbar(t)}
      </ha-card>
    `}renderCustomCardTheme(){switch(this.customCardTheme){case"theme_custom":break;case"theme_default":this.style.setProperty("--custom-card-background-color","#03A9F4"),this.style.setProperty("--custom-text-color","#FFFFFF"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#FFFFFF");break;case"theme_transp_blue":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","#03A9F4"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#03A9F4");break;case"theme_transp_black":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","black"),this.style.setProperty("--custom-primary-color","black"),this.style.setProperty("--custom-icon-color","black");break;case"theme_transp_white":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","white"),this.style.setProperty("--custom-primary-color","white"),this.style.setProperty("--custom-icon-color","white");break;case"theme_lightgrey_blue":this.style.setProperty("--custom-card-background-color","lightgrey"),this.style.setProperty("--custom-text-color","#03A9F4"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#03A9F4");break;default:this.style.setProperty("--custom-card-background-color","#03A9F4"),this.style.setProperty("--custom-text-color","#FFFFFF"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#FFFFFF")}}render(){return this.renderCustomCardTheme(),this.entity?this.compactView?this.renderCompact():this.renderFull():K`
        <ha-card>
          <div class="preview not-available">
            <div class="metadata">
              <div class="not-available">
                ${Qt("common.not_available")}
              </div>
            <div>
          </div>
        </ha-card>
      `}}),console.info("%cKEBA-CHARGER-CARD 0.0.12 IS INSTALLED","color: green; font-weight: bold",""),window.customCards=window.customCards||[],window.customCards.push({preview:!0,type:"keba-charger-card",name:Qt("common.name"),description:Qt("common.description")});
