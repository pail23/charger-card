...
`;console.info("%cKEBA-CHARGER-CARD 0.0.2 IS INSTALLED","color: green; font-weight: bold","");let ze=class extends B{static get styles(){return Se}static async getConfigElement(){return document.createElement("keba-charger-card-editor")}static getStubConfig(){return{entity:"",image:"default"}}get entity(){return null!=this.config.entity?this.hass.states[this.config.entity]:null}get scriptDomain(){return void 0===this.config.domain?"script":this.config.domain}get status(){if("off"==this.getEntityState(this.getEntity(Lt)))return It;return"on"==this.getEntityState(this.getEntity(Qt))?Jt:Wt}get usedChargerLimit(){const{dynamicChargerCurrent:t,dynamicCircuitCurrent:e,maxChargerCurrent:i,maxCircuitCurrent:r}=this.getEntities();return Math.min(this.getEntityState(t),this.getEntityState(e),this.getEntityState(i),this.getEntityState(r),0)}get image(){const t=this.config.chargerImage||"Generic",e=xe.find((({name:e})=>e===t?e:void 0));if(void 0===this.config.customImage||""===this.config.customImage)try{return void 0===e?void 0:e.img}catch(t){return""}return this.config.customImage}get customCardTheme(){return void 0===this.config.customCardTheme?"theme_default":this.config.customCardTheme}get showLeds(){return void 0===this.config.show_leds||this.config.show_leds}get showName(){return void 0===this.config.show_name||this.config.show_name}get showStatus(){return void 0===this.config.show_status||this.config.show_status}get showStats(){return void 0===this.config.show_stats||this.config.show_stats}get showCollapsibles(){return void 0===this.config.show_collapsibles||this.config.show_collapsibles}get showToolbar(){return void 0===this.config.show_toolbar||this.config.show_toolbar}get compactView(){return void 0!==this.config.compact_view&&this.config.compact_view}get entityBasename(){return void 0===this.config.entity?"":this.config.entity.split(".")[1].replace("_status","")}getEntityId(t){try{return t.split(".")[0]+"."+this.entityBasename+"_"+t.split(".")[1]}catch(t){return}}getEntityBase(t){try{return t.split(".")[0]+"."+t.split(".")[1].replace(this.entityBasename+"_","")}catch(t){return}}getEntities(){return{cableLocked:this.getEntity(Lt),cableLockedPermanently:this.getEntity(Nt),chargingState:this.getEntity(Qt),basicSchedule:this.getEntity(Bt),circuitCurrent:this.getEntity(Gt),costPerKwh:this.getEntity(Yt),dynamicChargerCurrent:this.getEntity(_t),dynamicCircuitCurrent:this.getEntity($t),enableIdleCurrent:this.getEntity(te),offlineCircuitCurrent:this.getEntity(se),inCurrent:this.getEntity(ee),isEnabled:this.getEntity(ie),maxChargerCurrent:this.getEntity(re),maxCircuitCurrent:this.getEntity(oe),isOnline:this.getEntity(ne),outputCurrent:this.getEntity(ae),reasonForNoCurrent:this.getEntity(le),sessionEnergy:this.getEntity(ce),energyPerHour:this.getEntity(de),energyLifetime:this.getEntity(he),smartCharging:this.getEntity(ue),totalPower:this.getEntity(pe),updateAvailable:this.getEntity(ge),voltage:this.getEntity(fe),status:this.entity}}getEntity(t){try{const e=this.getEntityId(t);return void 0===e?void 0:this.hass.states[e]}catch(t){return}}getEntityState(t){try{return t.state}catch(t){return}}getEntityAttribute(t,e){try{return t.attributes[e]}catch(t){return}}getStatsDefault(t){switch(t){case It:return[{entityId:this.getEntityId(ce),unit:"kWh",subtitle:qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(Lt),unit:"",subtitle:"Locked"}];case Wt:return[{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(ce),unit:"kWh",subtitle:qt("charger_status.sessionEnergy")},{entityId:this.getEntityId(ue),unit:"",subtitle:"Smart Charging"}];case Jt:return[{entityId:this.getEntityId(ce),unit:"kWh",subtitle:"Energy"},{entityId:this.getEntityId(de),unit:"kWh/h",subtitle:"Rate"},{entityId:this.getEntityId(Gt),unit:"A",subtitle:"Circuit"},{entityId:this.getEntityId(ae),unit:"A",subtitle:"Allowed"},{entityId:this.getEntityId(ee),unit:"A",subtitle:"Actual"},{entityId:this.getEntityId(pe),unit:"kW",subtitle:"Power"}];case Tt:case Dt:return[{entityId:this.getEntityId(ce),unit:"kWh",subtitle:qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"}];case Ft:return[{entityId:this.getEntityId(ce),unit:"kWh",subtitle:qt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(Bt),unit:"",subtitle:"Schedule"}]}return[]}setConfig(t){if(!t.entity)throw new Error(qt("error.missing_entity"));this.config=t}getCardSize(){return 2}shouldUpdate(t){return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var r=e.get("hass");return!r||r.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!0)}updated(t){this.config.entity&&t.get("hass")&&t.get("hass").states[this.config.entity].state!==this.hass.states[this.config.entity].state&&(this.requestInProgress=!1)}handleMore(t){t&&t.entity_id&&mt(this,"hass-more-info",{entityId:t.entity_id},{bubbles:!0,composed:!0})}_handleAction(t){this.hass&&this.config&&t.detail.action&&function(t,e,i,r){var o;"double_tap"===r&&i.double_tap_action?o=i.double_tap_action:"hold"===r&&i.hold_action?o=i.hold_action:"tap"===r&&i.tap_action&&(o=i.tap_action),yt(t,e,i,o)}(this,this.hass,this.config,t.detail.action)}setServiceData(t,e,i){switch(t){case me:{const r=i.target.getAttribute("value");return this.callService(t,e,{current:r})}case be:{const r=i.target.getAttribute("value");return this.callService(t,e,{current:r})}case ve:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}case ye:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}case Ae:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}}}callService(t,e=!0,i={}){this.hass.callService(this.scriptDomain,t,Object.assign({},i)),e&&this.requestUpdate()}imageLed(t,e){const i="on"==e?"smart":"normal";return Rt[i][t]||Rt[i].DEFAULT}renderImage(t){let e="";return this.compactView&&(e="-compact"),this.image?X`
    ...
    `}renderCollapsibleInfo(){if(!this.showCollapsibles)return X``;const{isOnline:t,totalPower:e,sessionEnergy:i,energyLifetime:r}=this.getEntities(),o=qt("common.click_for_info");return X`
      <div class="wrap-collabsible-info">
        ...
        <div class="collapsible-content-info">
          <div class="content-inner-info">
            ...
            ${this.renderCollapsibleItems(e,qt("common.power"))}
            ${this.renderCollapsibleItems(i,qt("charger_status.sessionEnergy"))}
            ${this.renderCollapsibleItems(r,qt("common.lifetime_energy"),!0)}
          </div>
        </div>
      </div>
    ...
    `}renderIcon(t){const e=t.entity_id,i=this.getEntityBase(e);return void 0!==this.getEntityAttribute(t,"icon")?this.getEntityAttribute(t,"icon"):(void 0===i?null:we[i])||"mdi:cancel"}renderToolbar(t){if(!this.showToolbar)return X``;let e=X``;switch(t){case It:case Dt:return X``;case Wt:case Tt:e=X`
          ${this.renderToolbarButton("keba_fast","mdi:play-box-multiple","common.start")}
          ${this.renderToolbarButton("keba_slow","mdi:animation-play","common.start")}
          ${this.renderToolbarButton("keba_auto","mdi:play-speed","common.start")}
        `;break;case Jt:case Ft:e=X`
