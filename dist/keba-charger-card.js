 ...
 */}function et(t){return tt({...t,state:!0})}var it=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,rt="[^\\s]+",ot=/\[([^]*?)\]/gm;function nt(t,e){for(var i=[],r=0,o=t.length;r<o;r++)i.push(t[r].substr(0,e));return i}var st=function(t){return function(e,i){var r=i[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return r>-1?r:null}};function at(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var r=0,o=e;r<o.length;r++){var n=o[r];for(var s in n)t[s]=n[s]}return t}var lt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ct=["January","February","March","April","May","June","July","August","September","October","November","December"],dt=nt(ct,3),ht={dayNamesShort:nt(lt,3),dayNames:lt,monthNamesShort:dt,monthNames:ct,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},ut=at({},ht),pt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},gt={D:function(t){return String(t.getDate())},DD:function(t){return pt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return pt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return pt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return pt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return pt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return pt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return pt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return pt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return pt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return pt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return pt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+pt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+pt(Math.floor(Math.abs(e)/60),2)+":"+pt(Math.abs(e)%60,2)}},ft=function(t){return+t-1},mt=[null,"[1-9]\\d?"],bt=[null,rt],yt=["isPm",rt,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],vt=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}],At=(st("monthNamesShort"),st("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var xt,wt,Ot=function(t,e,i){if(void 0===e&&(e=At.default),void 0===i&&(i={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var r=[];e=(e=At[e]||e).replace(ot,(function(t,e){return r.push(e),"@@@"}));var o=at(at({},ut),i);return(e=e.replace(it,(function(e){return gt[e](t,o)}))).replace(/@@@/g,(function(){return r.shift()}))};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(xt||(xt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(wt||(wt={}));var Vt=["closed","locked","off"],Ct=function(t,e,i,r){r=r||{},i=null==i?{}:i;var o=new Event(e,{bubbles:void 0===r.bubbles||r.bubbles,cancelable:Boolean(r.cancelable),composed:void 0===r.composed||r.composed});return o.detail=i,t.dispatchEvent(o),o},St=function(t){Ct(window,"haptic",t)},Mt=function(t,e,i,r){if(r||(r={action:"more-info"}),!r.confirmation||r.confirmation.exemptions&&r.confirmation.exemptions.some((function(t){return t.user===e.user.id}))||(St("warning"),confirm(r.confirmation.text||"Are you sure you want to "+r.action+"?")))switch(r.action){case"more-info":(i.entity||i.camera_image)&&Ct(t,"hass-more-info",{entityId:i.entity?i.entity:i.camera_image});break;case"navigate":r.navigation_path&&function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),Ct(window,"location-changed",{replace:i})}(0,r.navigation_path);break;case"url":r.url_path&&window.open(r.url_path);break;case"toggle":i.entity&&(function(t,e){(function(t,e,i){void 0===i&&(i=!0);var r,o=function(t){return t.substr(0,t.indexOf("."))}(e),n="group"===o?"homeassistant":o;switch(o){case"lock":r=i?"unlock":"lock";break;case"cover":r=i?"open_cover":"close_cover";break;default:r=i?"turn_on":"turn_off"}t.callService(n,r,{entity_id:e})})(t,e,Vt.includes(t.states[e].state))}(e,i.entity),St("success"));break;case"call-service":if(!r.service)return void St("failure");var o=r.service.split(".",2);e.callService(o[0],o[1],r.service_data),St("success");break;case"fire-dom-event":Ct(t,"ll-custom",r)}};var kt={disconnected:"Disconnected",awaiting_start:"Paused or awaiting start",charging:"Charging",completed:"Completed or awaiting car",error:"Error",ready_to_charge:"Ready to charge"},zt={name:"Charger Card",description:"Charger card allows you to control your charging robot.",start:"Start",continue:"Resume",pause:"Pause",stop:"Stop",override:"Override schedule",reboot:"Reboot charger",not_available:"Charger not available",click_for_info:"Click for Info",click_for_config:"Click for Config",click_for_limits:"Click for Limits",online:"Online",voltage:"Voltage",power:"Power",charger_current:"Changer Current",energy_per_hour:"Energy per Hour",lifetime_energy:"Lifetime Energy",circuit_current:"Circuit Energy"},Pt={missing_entity:"Specifying entity is required!"},Ht={entity:"Entity (Required)",chargerImage:"Charger image and color",customImage:"Custom image (Optional - overrides charger image)",theme:"Color theme",compact_view:"Compact View",compact_view_aria_label_on:"Toggle compact view on",compact_view_aria_label_off:"Toggle compact view off",show_name:"Show Name",show_name_aria_label_on:"Toggle display name on",show_name_aria_label_off:"Toggle display name off",show_leds:"Show Leds",show_leds_aria_label_on:"Toggle animated leds (overlay on image) on",show_leds_aria_label_off:"Toggle animated leds (overlay on image) off",show_status:"Show Status",show_status_aria_label_on:"Toggle display status on",show_status_aria_label_off:"Toggle display status off",show_stats:"Show Data Table (stats)",show_stats_aria_label_on:"Toggle display data table on",show_stats_aria_label_off:"Toggle display data table off",show_collapsibles:"Show collapsible menu buttons",show_collapsibles_aria_label_on:"Toggle display collapsible menus on",show_collapsibles_aria_label_off:"Toggle display collapsible menus off",show_toolbar:"Show Toolbar",show_toolbar_aria_label_on:"Toggle display toolbar on",show_toolbar_aria_label_off:"Toggle display toolbar off",code_only_note:"Note: Custom actions and data table (stats) options are available exclusively using Code Editor manually."},Xt={sessionEnergy:"Session Energy"},Dt={not_requesting_current:"Not requesting current",ok:"Ok",pending_schedule:"Pending Schedule",none:"None",max_circuit_current_too_low:"Max circuit current too low",max_dynamic_circuit_current_too_low:"Max dynamic circuit current too low",max_dynamic_offline_fallback_circuit_current_too_low:"Max dynamic offline circuit current too low",circuit_fuse_too_low:"Circuit fuse too low",waiting_in_queue:"Waiting in queue",waiting_in_fully:"Waiting in fully",illegal_grid_type:"Illegal grid type",no_current_request:"No current request",max_charger_current_too_low:"Max charger current too low",max_dynamic_charger_current_too_low:"Max dynamic charger current too low",charger_disabled:"Charger Disabled",pending_authorization:"Pending Authorization",charger_in_error_state:"Charger in error state",undefined:"Undefined"},It={status:kt,common:zt,error:Pt,editor:Ht,charger_status:Xt,charger_substatus:Dt},jt={disconnected:"Getrennt",awaiting_start:"Pausiert",charging:"Laden",completed:"Fertig",error:"Fehler",ready_to_charge:"Bereit zum Laden"},Ut={name:"Charger Card",description:"Charger card ermöglicht es dir, deinen Laderoboter zu steuern.",start:"Start",continue:"Weiter",pause:"Pause",stop:"Stopp",override:"Zeitplan überschreiben",reboot:"Ladegerät neu starten",not_available:"Ladegerät nicht verfügbar",click_for_info:"Klicken für Infos",click_for_config:"Klicken für Konfiguration",click_for_limits:"Klicken für Limits",online:"Online",voltage:"Spannung",power:"Leistung",charger_current:"Ladestrom",energy_per_hour:"Energie pro Stunde",lifetime_energy:"Energie gesamt",circuit_current:"Aktueller Strom"},qt={missing_entity:"Die Angabe der Entität ist erforderlich!"},Zt={entity:"Entity (Erforderlich)",chargerImage:"Bild und Farbe des Ladegeräts",customImage:"Benutzerdefiniertes Bild (Optional - überschreibt das Bild des Ladegeräts)",theme:"Farbschema",compact_view:"Kompakte Ansicht",compact_view_aria_label_on:"Kompakte Ansicht einschalten",compact_view_aria_label_off:"Kompakte Ansicht ausschalten",show_name:"Name anzeigen",show_name_aria_label_on:"Anzeigename einschalten",show_name_aria_label_off:"Anzeigename ausschalten",show_leds:"Leds anzeigen",show_leds_aria_label_on:"Animierte Leds (Überlagerung des Bildes) einschalten",show_leds_aria_label_off:"Animierte Leds (Überlagerung des Bildes) ausschalten",show_status:"Status anzeigen",show_status_aria_label_on:"Statusanzeige einschalten",show_status_aria_label_off:"Statusanzeige ausschalten",show_stats:"Datentabelle anzeigen (Statistik)",show_stats_aria_label_on:"Datentabelle einschalten",show_stats_aria_label_off:"Datentabelle ausschalten",show_collapsibles:"Zusammenklappbare Menüschaltflächen anzeigen",show_collapsibles_aria_label_on:"Zusammenklappbare Menüschaltflächen einschalten",show_collapsibles_aria_label_off:"Zusammenklappbare Menüschaltflächen ausschalten",show_toolbar:"Symbolleiste anzeigen",show_toolbar_aria_label_on:"Symbolleiste einschalten",show_toolbar_aria_label_off:"Symbolleiste ausschalten",code_only_note:"Hinweis: Die Optionen für benutzerdefinierte Aktionen und Datentabellen (Statistiken) sind ausschließlich über den manuellen Code-Editor verfügbar."},Kt={sessionEnergy:"Energieaufladung"},Et={not_requesting_current:"Keine Nachfrage nach Strom",ok:"Ok",pending_schedule:"Ausstehender Zeitplan",none:"None",max_circuit_current_too_low:"Maximalstrom zu niedrig",max_dynamic_circuit_current_too_low:"Dynamischer Maximalstrom zu niedrig",max_dynamic_offline_fallback_circuit_current_too_low:"Dynamischer offline Maximalstrom zu niedrig",circuit_fuse_too_low:"Stromkreissicherung zu niedrig",waiting_in_queue:"Warten in der Warteschlange",waiting_in_fully:"Warten in vollem Umfang",illegal_grid_type:"Unzulässiger Grid Typ",no_current_request:"Keine aktuelle Anfrage",max_charger_current_too_low:"Maximaler Ladestrom zu niedrig",max_dynamic_charger_current_too_low:"Maximaler dynamischer Ladestrom zu niedrig",charger_disabled:"Ladegerät Deaktiviert",pending_authorization:"Ausstehende Autorisierung",charger_in_error_state:"Ladegerät im Fehlerzustand",undefined:"Undefiniert"},Tt={status:jt,common:Ut,error:qt,editor:Zt,charger_status:Kt,charger_substatus:Et};const Wt={en:Object.freeze({__proto__:null,status:kt,common:zt,error:Pt,editor:Ht,charger_status:Xt,charger_substatus:Dt,default:It}),de:Object.freeze({__proto__:null,status:jt,common:Ut,error:qt,editor:Zt,charger_status:Kt,charger_substatus:Et,default:Tt})};function Jt(t,e="",i=""){const r=(navigator.language||"en").split("-")[0];let o;try{o=t.split(".").reduce((t,e)=>t[e],Wt[r])}catch(e){o=t.split(".").reduce((t,e)=>t[e],Wt.en)}return void 0===o&&(o=t.split(".").reduce((t,e)=>t[e],Wt.en)),""!==e&&""!==i&&(o=o.replace(e,i)),o}const Ft="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIGAgIAAAAAAAAAAAAACDYSPqcvtD6OctNqLVQEAOw==",Lt="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHD///8AAAAAAAACGYSDqZvmwOJ6R1oKrcR60x5x4PSNimgiTgEAOw==",Rt="data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHAAJv8AAAAAAAACGYSDqZvmwOJ6R1oKrcR60x5x4PSNimgiTgEAOw==",Nt="data:image/gif;base64,R0lGODlhAwBIAIEAAAAAAGBgYP8AAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh/hZDcmVhdGVkIHdpdGggUGFpbnQuTkVUACH5BAkZAAAALAAAAAADAEgAAAINjI+py+0Po5y02otVAQAh+QQJGQAAACwAAAEAAwBGAAACF5SPecCtn5qDVDJaLYYW7Nd9SigiZGkUADs=",Bt="disconnected",Qt="awaiting_start",Yt="charging",Gt="completed",_t="error",$t="ready_to_charge",te={normal:{DEFAULT:Ft,disconnected:"data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHBgYGD///8AAAACHYSDqZvmwOJ6R1oKrcR60x5x4EQJ5ommJ6a2qVMAADs=",awaitingStart:Lt,charging:"data:image/gif;base64,",completed:Lt,error:Nt,readyToCharge:Lt},smart:{DEFAULT:Ft,disconnected:"data:image/gif;base64,R0lGODlhAwBIAHAAACwAAAAAAwBIAIFwcHBgYGAAJv8AAAACHYSDqZvmwOJ6R1oKrcR60x5x4EQJ5ommJ6a2qVMAADs=",awaitingStart:Rt,charging:"data:image/gif;base64,",completed:Rt,error:Nt,readyToCharge:Rt}},ee="binary_sensor.plug",ie="switch.cable_locked_permanently",re="binary_sensor.charging_state",oe="binary_sensor.basic_schedule",ne="sensor.circuit_current",se="sensor.cost_per_kwh",ae="sensor.dynamic_charger_limit",le="sensor.dynamic_circuit_limit",ce="switch.enable_idle_current",de="sensor.current",he="switch.is_enabled",ue="sensor.max_current",pe="sensor.max_circuit_limit",ge="sensor.offline_circuit_limit",fe="binary_sensor.status",me="sensor.output_limit",be="sensor.reason_for_no_current",ye="sensor.session_energy",ve="sensor.energy_per_hour",Ae="sensor.total_energy",xe="switch.smart_charging",we="sensor.charging_power",Oe="binary_sensor.update_available",Ve="sensor.voltage",Ce="set_charger_max_limit",Se="set_charger_dynamic_limit",Me="set_charger_circuit_max_limit",ke="set_charger_circuit_dynamic_limit",ze="set_charger_circuit_offline_limit",Pe=[{name:"Generic",img:"data:image/png;base64,"}],He={"binary_sensor.plug":"mdi:lock","switch.cable_locked_permanently":"mdi:lock","binary_sensor.basic_schedule":"mdi:clock-check","sensor.circuit_current":"mdi:sine-wave","sensor.cost_per_kwh":"mdi:currency-usd","sensor.dynamic_charger_limit":"mdi:sine-wave","sensor.dynamic_circuit_limit":"mdi:sine-wave","switch.enable_idle_current":"mdi:current-dc","sensor.offline_circuit_limit":"mdi:sine-wave","sensor.current":"mdi:sine-wave","switch.is_enabled":"mdi:power","sensor.max_current":"mdi:sine-wave","sensor.max_circuit_limit":"mdi:sine-wave","binary_sensor.status":"mdi:wifi","sensor.output_limit":"mdi:sine-wave","sensor.reason_for_no_current":"mdi:alert-circle","sensor.session_energy":"mdi:flash","sensor.energy_per_hour":"mdi:flash","sensor.total_energy":"mdi:flash","switch.smart_charging":"mdi:auto-fix","sensor.charging_power":"mdi:flash","binary_sensor.update_available":"mdi:file-download","sensor.voltage":"mdi:sine-wave"},Xe=[8,10,16,20,25,32],De=[{name:"theme_default",desc:"Default HA colors"},{name:"theme_custom",desc:"Use custom theme"},{name:"theme_transp_blue",desc:"Transparent Blue"},{name:"theme_transp_black",desc:"Transparent Black"},{name:"theme_transp_white",desc:"Transparent White"},{name:"theme_lightgrey_blue",desc:"LightGrey Blue"}];let Ie=class extends G{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this._config.entity||(this._config.entity=this.getEntitiesByType("binary_sensor")[0]||"",Ct(this,"config-changed",{config:this._config})),this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _entity(){return this._config&&this._config.entity||""}get _customImage(){return this._config&&this._config.customImage||""}get _chargerImage(){return this._config&&this._config.chargerImage||"Generic"}get _customCardTheme(){return this._config?this._config.customCardTheme||"":"theme_default"}get showName(){return!this._config||(void 0===this._config.show_name||this._config.show_name)}get showLeds(){return!this._config||(void 0===this._config.show_leds||this._config.show_leds)}get showStatus(){return!this._config||(void 0===this._config.show_status||this._config.show_status)}get showToolbar(){return!this._config||(void 0===this._config.show_toolbar||this._config.show_toolbar)}get showStats(){return!this._config||(void 0===this._config.show_stats||this._config.show_stats)}get showCollapsibles(){return!this._config||(void 0===this._config.show_collapsibles||this._config.show_collapsibles)}get compactView(){return!!this._config&&(void 0!==this._config.compact_view&&this._config.compact_view)}getEntitiesByType(t){return this.hass?Object.keys(this.hass.states).filter(e=>e.substr(0,e.indexOf("."))===t):[]}render(){if(!this.hass)return D``;const t=Object.keys(this.hass.states).filter(t=>"binary_sensor"===t.substr(0,t.indexOf(".")));return D`
      <div class="card-config">
        ...
        <paper-dropdown-menu label="${Jt("editor.theme")}" @value-changed=${this._valueChanged} .configValue=${"customCardTheme"}>
        ...
        <paper-dropdown-menu label="${Jt("editor.chargerImage")}" @value-changed=${this._valueChanged} .configValue=${"chargerImage"}>
        ...
        <paper-input label="${Jt("editor.customImage")}" .value=${this._customImage} .configValue=${"customImage"} @value-changed=${this._valueChanged}"></paper-input>

        <p class="option">
          <ha-switch
            aria-label=${Jt(this.compactView?"editor.compact_view_aria_label_off":"editor.compact_view_aria_label_on")}
            .checked=${!1!==this.compactView}
            .configValue=${"compact_view"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Jt("editor.compact_view")}
        </p>

        <p class="option">
          <ha-switch
            aria-label=${Jt(this.showName?"editor.show_name_aria_label_off":"editor.show_name_aria_label_on")}
        ...
        <p class="option">
          <ha-switch
            aria-label=${Jt(this.showLeds?"editor.show_leds_aria_label_off":"editor.show_leds_aria_label_on")}
        ...
        <p class="option">
          <ha-switch
            aria-label=${Jt(this.showStatus?"editor.show_status_aria_label_off":"editor.show_status_aria_label_on")}
            .checked=${!1!==this.showStatus}
            .configValue=${"show_status"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Jt("editor.show_status")}
        </p>

        <p class="option">
        <ha-switch
          aria-label=${Jt(this.showCollapsibles?"editor.show_collapsibles_aria_label_off":"editor.show_collapsibles_aria_label_on")}
          .checked=${!1!==this.showCollapsibles}
          .configValue=${"show_collapsibles"}
          @change=${this._valueChanged}
        >
        </ha-switch>
        ${Jt("editor.show_collapsibles")}
      </p>

        <p class="option">
          <ha-switch
            aria-label=${Jt(this.showStats?"editor.show_stats_aria_label_off":"editor.show_stats_aria_label_on")}
            .checked=${this.showStats}
            .configValue=${"show_stats"}
            @change=${this._valueChanged}
          >
          </ha-switch>
          ${Jt("editor.show_stats")}
        </p>
    ...
    `}};t([tt({attribute:!1})],Ie.prototype,"hass",void 0),t([et()],Ie.prototype,"_config",void 0),t([et()],Ie.prototype,"_toggle",void 0),t([et()],Ie.prototype,"_helpers",void 0),Ie=t([_("keba-charger-card-editor")],Ie);var je=s`
  :host {
    display: flex;
    flex: 1;
...
`;console.info("%cKEBA-CHARGER-CARD 0.0.2 IS INSTALLED","color: green; font-weight: bold","");let Ue=class extends G{static get styles(){return je}static async getConfigElement(){return document.createElement("keba-charger-card-editor")}static getStubConfig(){return{entity:"",image:"default"}}get entity(){return null!=this.config.entity?this.hass.states[this.config.entity]:null}get chargerDomain(){return void 0===this.config.domain?"keba":this.config.domain}get status(){if("off"==this.getEntityState(this.getEntity(ee)))return Bt;return"on"==this.getEntityState(this.getEntity(re))?Yt:Qt}get usedChargerLimit(){const{dynamicChargerCurrent:t,dynamicCircuitCurrent:e,maxChargerCurrent:i,maxCircuitCurrent:r}=this.getEntities();return Math.min(this.getEntityState(t),this.getEntityState(e),this.getEntityState(i),this.getEntityState(r),0)}get image(){const t=this.config.chargerImage||"Generic",e=Pe.find(({name:e})=>e===t?e:void 0);if(void 0===this.config.customImage||""===this.config.customImage)try{return void 0===e?void 0:e.img}catch(t){return""}return this.config.customImage}get customCardTheme(){return void 0===this.config.customCardTheme?"theme_default":this.config.customCardTheme}get showLeds(){return void 0===this.config.show_leds||this.config.show_leds}get showName(){return void 0===this.config.show_name||this.config.show_name}get showStatus(){return void 0===this.config.show_status||this.config.show_status}get showStats(){return void 0===this.config.show_stats||this.config.show_stats}get showCollapsibles(){return void 0===this.config.show_collapsibles||this.config.show_collapsibles}get showToolbar(){return void 0===this.config.show_toolbar||this.config.show_toolbar}get compactView(){return void 0!==this.config.compact_view&&this.config.compact_view}get entityBasename(){return void 0===this.config.entity?"":this.config.entity.split(".")[1].replace("_status","")}getEntityId(t){try{return t.split(".")[0]+"."+this.entityBasename+"_"+t.split(".")[1]}catch(t){return}}getEntityBase(t){try{return t.split(".")[0]+"."+t.split(".")[1].replace(this.entityBasename+"_","")}catch(t){return}}getEntities(){return{cableLocked:this.getEntity(ee),cableLockedPermanently:this.getEntity(ie),chargingState:this.getEntity(re),basicSchedule:this.getEntity(oe),circuitCurrent:this.getEntity(ne),costPerKwh:this.getEntity(se),dynamicChargerCurrent:this.getEntity(ae),dynamicCircuitCurrent:this.getEntity(le),enableIdleCurrent:this.getEntity(ce),offlineCircuitCurrent:this.getEntity(ge),inCurrent:this.getEntity(de),isEnabled:this.getEntity(he),maxChargerCurrent:this.getEntity(ue),maxCircuitCurrent:this.getEntity(pe),isOnline:this.getEntity(fe),outputCurrent:this.getEntity(me),reasonForNoCurrent:this.getEntity(be),sessionEnergy:this.getEntity(ye),energyPerHour:this.getEntity(ve),energyLifetime:this.getEntity(Ae),smartCharging:this.getEntity(xe),totalPower:this.getEntity(we),updateAvailable:this.getEntity(Oe),voltage:this.getEntity(Ve),status:this.entity}}getEntity(t){try{const e=this.getEntityId(t);return void 0===e?void 0:this.hass.states[e]}catch(t){return}}getEntityState(t){try{return t.state}catch(t){return}}getEntityAttribute(t,e){try{return t.attributes[e]}catch(t){return}}getStatsDefault(t){switch(t){case Bt:return[{entityId:this.getEntityId(ye),unit:"kWh",subtitle:Jt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(ee),unit:"",subtitle:"Locked"}];case Qt:return[{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(ye),unit:"kWh",subtitle:Jt("charger_status.sessionEnergy")},{entityId:this.getEntityId(xe),unit:"",subtitle:"Smart Charging"}];case Yt:return[{entityId:this.getEntityId(ye),unit:"kWh",subtitle:"Energy"},{entityId:this.getEntityId(ve),unit:"kWh/h",subtitle:"Rate"},{entityId:this.getEntityId(ne),unit:"A",subtitle:"Circuit"},{entityId:this.getEntityId(me),unit:"A",subtitle:"Allowed"},{entityId:this.getEntityId(de),unit:"A",subtitle:"Actual"},{entityId:this.getEntityId(we),unit:"kW",subtitle:"Power"}];case Gt:case _t:return[{entityId:this.getEntityId(ye),unit:"kWh",subtitle:Jt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"}];case $t:return[{entityId:this.getEntityId(ye),unit:"kWh",subtitle:Jt("charger_status.sessionEnergy")},{calcValue:this.usedChargerLimit,unit:"A",subtitle:"Current Limit"},{entityId:this.getEntityId(oe),unit:"",subtitle:"Schedule"}]}return[]}setConfig(t){if(!t.entity)throw new Error(Jt("error.missing_entity"));this.config=t}getCardSize(){return 2}shouldUpdate(t){return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var r=e.get("hass");return!r||r.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!0)}updated(t){this.config.entity&&t.get("hass")&&t.get("hass").states[this.config.entity].state!==this.hass.states[this.config.entity].state&&(this.requestInProgress=!1)}handleMore(t){t&&t.entity_id&&Ct(this,"hass-more-info",{entityId:t.entity_id},{bubbles:!0,composed:!0})}_handleAction(t){this.hass&&this.config&&t.detail.action&&function(t,e,i,r){var o;"double_tap"===r&&i.double_tap_action?o=i.double_tap_action:"hold"===r&&i.hold_action?o=i.hold_action:"tap"===r&&i.tap_action&&(o=i.tap_action),Mt(t,e,i,o)}(this,this.hass,this.config,t.detail.action)}setServiceData(t,e,i){switch(t){case Ce:{const r=i.target.getAttribute("value");return this.callService(t,e,{current:r})}case Se:{const r=i.target.getAttribute("value");return this.callService(t,e,{current:r})}case ze:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}case Me:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}case ke:{const r=i.target.getAttribute("value");return this.callService(t,e,{currentP1:r})}}}callService(t,e=!0,i={}){this.hass.callService(this.chargerDomain,t,Object.assign({},i)),e&&this.requestUpdate()}imageLed(t,e){const i="on"==e?"smart":"normal";return te[i][t]||te[i].DEFAULT}renderImage(t){let e="";return this.compactView&&(e="-compact"),this.image?D`
      <img
        class="charger${e}"
        src="${this.image}"
        ...
        ?more-info="true"
      />${this.renderLeds(t)}
    `:D``}renderLeds(t){if(console.log(t),this.showLeds){let e="";this.compactView&&(e="-compact");const i=this.getEntityState(this.getEntity(xe));return D`
        <img
          class="charger led${e}"
          src="${this.imageLed(t,i)}"
          @action=${this._handleAction}
        />
      `}return D``}renderStats(t){if(!this.showStats)return D``;let e="";this.compactView&&(e="-compact");const i=this.getStatsDefault(t)||[];return D`
      <div class="stats${e}">
        ${this.renderStatsList(i)}
      </div>
    `}renderStatsList(t){return t.map(({entityId:t,attribute:e,calcValue:i,unit:r,subtitle:o})=>{if(!(t||e||i))return D``;if(i)return this.renderStatsHtml(i,r,o,this.hass.states[t]);try{const i=e?this.hass.states[t].attributes[e]:this.hass.states[t].state;return this.renderStatsHtml(i,r,o,this.hass.states[t])}catch(t){return null}})}renderStatsHtml(t,e,i,r){return D`
    ...
    `}renderName(){if(!this.showName)return D``;let t="";return this.compactView&&(t="-compact"),D`
      <div class="charger-name${t}">
        Keba P30
      </div>
    `}renderStatus(){if(!this.showStatus)return D``;let t="";this.compactView&&(t="-compact");const e=Jt("status."+this.status)||this.status;return D`
      <div class="status${t}">
    ...
    `}renderCollapsibleConfig(){if(!this.showCollapsibles)return D``;const{cableLocked:t,cableLockedPermanently:e,enableIdleCurrent:i,isEnabled:r,smartCharging:o}=this.getEntities(),n=Jt("common.click_for_config");return D`
      <div class="wrap-collabsible">
        <input id="collapsible" class="toggle" type="checkbox" />
        <label for="collapsible" class="lbl-toggle">
          <div class="tooltip-right">
            <ha-icon icon="mdi:cog"></ha-icon>
            <span class="tooltiptext-right">${n}</span>
          </div>
        </label>
        <div class="collapsible-content">
          <div class="content-inner">
            ${this.renderCollapsibleItems(r,"Enabled")}
            ${this.renderCollapsibleItems(i,"Idle Current")}
    ...
    `}renderCollapsibleInfo(){if(!this.showCollapsibles)return D``;const{isOnline:t,voltage:e,totalPower:i,circuitCurrent:r,inCurrent:o,sessionEnergy:n,energyPerHour:s,energyLifetime:a}=this.getEntities(),l=Jt("common.click_for_info");return D`
      <div class="wrap-collabsible-info">
        ...
        <div class="collapsible-content-info">
          <div class="content-inner-info">
            ${this.renderCollapsibleItems(t,Jt("common.online"))}
            ${this.renderCollapsibleItems(e,Jt("common.voltage"),!0)}
            ${this.renderCollapsibleItems(i,Jt("common.power"))}
            ${this.renderCollapsibleItems(o,Jt("common.charger_current"),!0)}
            ${this.renderCollapsibleItems(r,Jt("common.circuit_current"),!0)}
            ${this.renderCollapsibleItems(s,Jt("common.energy_per_hour"))}
            ${this.renderCollapsibleItems(n,Jt("charger_status.sessionEnergy"))}
            ${this.renderCollapsibleItems(a,Jt("common.lifetime_energy"),!0)}
          </div>
        </div>
      </div>
    `}renderCollapsibleLimits(){if(!this.showCollapsibles)return D``;const{maxChargerCurrent:t,maxCircuitCurrent:e,dynamicChargerCurrent:i,dynamicCircuitCurrent:r,offlineCircuitCurrent:o}=this.getEntities(),n=Jt("common.click_for_limits");return D`
      <div class="wrap-collabsible-lim">
        ...
        <div class="collapsible-content-lim">
          <div class="content-inner-lim">
            ${this.renderCollapsibleDropDownItems(t,Ce,void 0,"Max Charger Limit",!0)}
            ${this.renderCollapsibleDropDownItems(i,Se,void 0,"Dyn Charger Limit",!0)}
            ${this.renderCollapsibleDropDownItems(e,Me,void 0,"Max Circuit Limit",!0)}
            ${this.renderCollapsibleDropDownItems(r,ke,void 0,"Dyn Circuit Limit",!0)}
            ${this.renderCollapsibleDropDownItems(o,ze,void 0,"Offline Limit",!0)}
          </div>
        </div>
      </div>
    `}renderCollapsibleItems(t,e,i=!1){if(null==t)return D`
        x
      `;const r=i?Math.round(this.getEntityState(t)):this.getEntityState(t),o=this.renderIcon(t),n=this.getEntityAttribute(t,"unit_of_measurement");return D`
    ...
    `}renderCollapsibleServiceItems(t,e,i,r,o,n=!0,s={}){let a=r;return null==r&&(a=this.renderIcon(t)),D`
      <div class="collapsible-item" @click="${()=>this.callService(e,n,s)}">
        <div class="tooltip">
    ...
    `}renderCollapsibleDropDownItems(t,e,i,r,o=!0){if(null==t)return D``;const n=Xe,s=this.getEntityState(t),a=n.indexOf(s),l=this.getEntityAttribute(t,"unit_of_measurement"),c=void 0===i?this.renderIcon(t):i;return D`
      <paper-menu-button slot="dropdown-trigger" .noAnimations=${!0} @click="${t=>t.stopPropagation()}">
        ...
        <paper-listbox
          ...
          selected=${a}
          @click="${t=>this.setServiceData(e,o,t)}"
        >
          ${n.map(t=>D`
    ...
    `}renderInfoItemsLeft(){const{isOnline:t}=this.getEntities();return D`
      ${this.renderInfoItem(t,Jt("common.online"))}
    `}renderInfoItemsRight(){const{cableLocked:t,totalPower:e,voltage:i}=this.getEntities(),r=t&&"on"==t.state?"mdi:power-plug":"mdi:power-plug-off";return D`
      ${this.renderInfoItem(i,Jt("common.voltage"),!0)}
      ${this.renderInfoItem(e,Jt("common.power"))}
      <ha-icon icon="${r}"></ha-icon>
    `}renderInfoItemsCompact(){const{totalPower:t,voltage:e}=this.getEntities();return D`
      ${this.renderInfoItem(e,Jt("common.voltage"),!0)}
      ${this.renderInfoItem(t,Jt("common.power"),!0)}
    `}renderInfoItem(t,e,i=!1){if(null==t)return D``;const r=i?Math.round(this.getEntityState(t)):this.getEntityState(t),o=this.getEntityAttribute(t,"unit_of_measurement"),n=this.renderIcon(t);return D`
    ...
    `}renderIcon(t){const e=t.entity_id,i=this.getEntityBase(e);return void 0!==this.getEntityAttribute(t,"icon")?this.getEntityAttribute(t,"icon"):(void 0===i?null:He[i])||"mdi:cancel"}renderToolbar(t){if(!this.showToolbar)return D``;const{actions:e=[]}=this.config,i=e.map(({name:t,service:e,icon:i,serviceData:r})=>this.renderToolbarButton(e,i,t,r));let r=D``;switch(t){case Bt:r=D``;break;case Qt:r=D`
          ${this.renderToolbarButton("enable","mdi:play","common.start")}
          ${this.renderToolbarButton("set_current","mdi:play-box-multiple","common.start",{current:10})}
          ${this.renderToolbarButton("set_current","mdi:animation-play","common.start",{current:25})}
          ${this.renderToolbarButton("set_current","mdi:play-speed","common.start",{current:25})}
        `;break;case Yt:r=D`
          ${this.renderToolbarButton("disable","hass:stop","common.stop")}
        `;break;case Gt:r=D`
          ${this.renderToolbarButton("enable","hass:play","common.start")}
        `;break;case _t:r=D``;break;case $t:r=D`
          ${this.renderToolbarButton("disable","hass:stop","common.stop")}
        `}return D`
      <div class="toolbar">
        ${r}
    ...
    `}renderToolbarButton(t,e,i,r={},o=!0){let n="";try{n=Jt(i)}catch(t){n=i}return D`
      <div class="tooltip">
        <ha-icon-button
          icon="${e}"
          title="${n}"
    ...
    `}renderCompact(){const t=this.status;return D`
      <ha-card>
    ...
    `}renderFull(){const t=this.status;return D`
      <ha-card>
        <div class="preview">
          <div class="header">
    ...
    `}renderCustomCardTheme(){switch(this.customCardTheme){case"theme_custom":break;case"theme_default":this.style.setProperty("--custom-card-background-color","#03A9F4"),this.style.setProperty("--custom-text-color","#FFFFFF"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#FFFFFF");break;case"theme_transp_blue":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","#03A9F4"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#03A9F4");break;case"theme_transp_black":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","black"),this.style.setProperty("--custom-primary-color","black"),this.style.setProperty("--custom-icon-color","black");break;case"theme_transp_white":this.style.setProperty("--custom-card-background-color","transparent"),this.style.setProperty("--custom-text-color","white"),this.style.setProperty("--custom-primary-color","white"),this.style.setProperty("--custom-icon-color","white");break;case"theme_lightgrey_blue":this.style.setProperty("--custom-card-background-color","lightgrey"),this.style.setProperty("--custom-text-color","#03A9F4"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#03A9F4");break;default:this.style.setProperty("--custom-card-background-color","#03A9F4"),this.style.setProperty("--custom-text-color","#FFFFFF"),this.style.setProperty("--custom-primary-color","#03A9F4"),this.style.setProperty("--custom-icon-color","#FFFFFF")}}render(){return this.renderCustomCardTheme(),this.entity?this.compactView?this.renderCompact():this.renderFull():D`
      ...
      `}};t([tt({attribute:!1})],Ue.prototype,"hass",void 0),t([et()],Ue.prototype,"config",void 0),t([tt({attribute:!1})],Ue.prototype,"requestInProgress",void 0),Ue=t([_("keba-charger-card")],Ue);export{Ue as ChargerCard};
